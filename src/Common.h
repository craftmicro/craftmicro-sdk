...
namespace craft {
	...
	/**
	 * Calculate and output performance benchmark data to serial. Default is 0
	 **/
	#define CRAFTMICRO_BENCHMARK 1
	...
	#define CRAFTMICRO_USE_DOUBLE 0
	   ...
	   * situations where you are using 1000s of simultaneous objects you may need
	...
	#define CRAFTMICRO_USE_DMA 0
		...
		/**
		 * The Display SPI is automatically detected on some hardware (Kinetisk and ESP32)
		 * However, it can be set manually if required.
		 */
		 //#define CRAFTMICRO_DISPLAY_SPI 1
	...
	#define CRAFTMICRO_GUI_MAX_TITLE_LEN 32
		 ...
		 /**
		  * @brief Maximum acronym length for GUI widgets (default 3)
		  */
